...
$txt['registration_disabled']   =   'Sorry, registration via SMF is disabled. Registration for this forum must be done via the Tracker <a href="http://www.gizd.cz/index.php?page=signup">Here</a>.<br /><br />If you already have a tracker account please <a href="http://www.gizd.cz/index.php?action=login">login here</a> with the same credentials.';
